...
function makeCorsRequest() {
    ...
    if (city_name === ""){
        url = "http://api.openweathermap.org/data/2.5/forecast/hourly?q=Davis,CA,US&units=imperial&APPID=f6e80ec13a2fdb65b7a01b126cf2ea5b";
        
    } else {
        url = "http://api.openweathermap.org/data/2.5/forecast/hourly?q=" + city_name + "&units=imperial&APPID=f6e80ec13a2fdb65b7a01b126cf2ea5b";
    }
        ...
        let xhr = createCORSRequest('GET', url);
          ...
          xhr.onload = function() {
              ...
              if (object.city.coord.lat > 40.6 || object.city.coord.lat < 36.5 || object.city.coord.long > 123.5 || object.city.coord.long < 199.5) {
...
function setTemperatures(temp_list) {
    ...
    content.textContent = Math.floor(temp_list[0].main.temp) + String.fromCharCode(176);
    
    content = document.getElementById("hour_+1_temp_id");
    content.textContent = Math.floor(temp_list[1].main.temp) + String.fromCharCode(176);
    
    content = document.getElementById("hour_+2_temp_id");
    content.textContent = Math.floor(temp_list[2].main.temp) + String.fromCharCode(176);
    
    content = document.getElementById("hour_+3_temp_id");
    content.textContent = Math.floor(temp_list[3].main.temp) + String.fromCharCode(176);
    
    content = document.getElementById("hour_+4_temp_id");
    content.textContent = Math.floor(temp_list[4].main.temp) + String.fromCharCode(176);
    
    content = document.getElementById("hour_+5_temp_id");
    content.textContent = Math.floor(temp_list[5].main.temp) + String.fromCharCode(176);
...
function getgreenMapImage(){
	...
	newImage.src = "http://radar.weather.gov/ridge/Overlays/Topo/Short/DAX_Topo_Short.jpg";
...
function cityNamesImage(){
	...
	newImage.src = "http://radar.weather.gov/ridge/Overlays/Cities/Short/DAX_City_Short.gif";
